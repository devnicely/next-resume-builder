...
const sectionMap = (Section: React.FC<SectionProps>): Record<string, JSX.Element> => ({
  candidate_information: <Section key="candidate_information" path='sections.candidate_information' titlePath={['candidate_name', 'candidate_email', 'candidate_phone', 'candidate_website']}/>,
  ...
  awards: <Section key="awards" path="sections.awards" headlinePath='year' titlePath='title' subtitlePath='organization'/>,
  ...
  cover_candidate_name: <Section key="cover_candidate_name" path='sections.cover_candidate_name'/>,
  cover_candidate_email: <Section key="cover_candidate_email" path='sections.cover_candidate_email'/>,
  cover_candidate_phone: <Section key="cover_candidate_phone" path='sections.cover_candidate_phone'/>,
  cover_candidate_website: <Section key="cover_candidate_website" path='sections.cover_candidate_website'/>,
