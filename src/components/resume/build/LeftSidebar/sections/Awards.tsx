...
const Awards = () => {
    return(
        <>
            <Heading isEditable={true} isHideable={true} isUppercase={true} path="sections.awards" name="Awards & Honors"/>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <ResumeInput  label="Year" path="sections.awards.items[0].year"  className="sm:col-span-1"/>
            </div>
        </>
    )   
}
